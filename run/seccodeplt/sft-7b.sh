...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nnodes=1 --nproc_per_node=2 -m verl.trainer.fsdp_sft_trainer \
    ...
    trainer.experiment_name="sft_7b_bs8_epoch4" \
    trainer.total_epochs=4 \
    trainer.default_local_dir='./checkpoints/sft_7b_bs8_epoch4' \
    trainer.logger=['console'] 2>&1 | tee ./log/sft_7b_bs8_epoch4.log  # use ['console','wandb'] and specify the key above if you want to log in wandb